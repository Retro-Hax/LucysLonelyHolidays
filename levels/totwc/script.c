...
const LevelScript level_totwc_entry[] = {
	...
	AREA(1, totwc_area_1),
		...
		OBJECT(MODEL_NONE, -14442, 1548, 21, 0, 0, 0, 0x02000000, bhvHiddenRedCoinStar),
		...
		OBJECT(MODEL_STAR, 9046, 1196, -2637, 0, -180, 0, 0x01000000, bhvStar),
		OBJECT(MODEL_YELLOW_COIN, -13422, 1617, -1572, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, -13382, 1616, 1532, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, -10596, 1622, 1460, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, -10596, 1613, -1429, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, -9442, 1618, 51, 0, 0, 0, 0x00000000, bhvYellowCoin),
