...
const LevelScript level_bitfs_entry[] = {
	...
	AREA(1, bitfs_area_1),
		...
		OBJECT(MODEL_GOOMBA, -863, -1001, 1777, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -3763, -1001, 2452, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -2143, -1001, 1717, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -2187, -1001, 2615, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -1149, -1001, 2461, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -163, -1001, 2001, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -2754, -1001, 2198, 0, 0, 0, 0x00000000, bhvGoomba),
		...
		OBJECT(MODEL_NONE, 6279, -732, -2027, 0, 0, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, 6932, 556, -924, 0, 0, 0, 0x02000000, bhvHiddenStar),
		...
		OBJECT(MODEL_NONE, 6938, -298, -932, 0, 0, 0, 0x01000000, bhvHiddenRedCoinStar),
